...
class Kayak(object):
    ...
    def start_flight_search(self, origin, destination, depart_date, return_date, depart_time='a', return_time='a', travelers=2, cabin='e', oneway=False):
        params = [
            ('action', 'doflights'),
            ('apimode', '1'),
            ('basicmode', 'true'),
    ...
    def find_flights(self, origin, destination, depart_date, return_date, depart_time='a', return_time='a', travelers=2, cabin='e', oneway=False, count=10):
        search_id = self.start_flight_search(origin, destination, depart_date, return_date, depart_time, return_time, travelers, cabin, oneway)
...
if __name__ == '__main__':
    k = Kayak(API_KEY)
    k.find_flights('MSP', 'HNL', '10/05/2023', '10/06/2023')